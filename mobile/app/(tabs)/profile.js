  ...
  return (
    <SafeAreaView style={s.root}>
      ...
      <ScrollView contentContainerStyle={s.body}>
        ...
        {profile?.name ? <Text style={s.name}>{profile.name}</Text> : null}
...
const s = StyleSheet.create({
  ...
  avatarCircle:   { width: 96, height: 96, borderRadius: 48, backgroundColor: C.blue, justifyContent: 'center', alignItems: 'center' },
  ...
  card:           { width: '100%', backgroundColor: C.white, borderRadius: 16, paddingVertical: 6, paddingHorizontal: 16, elevation: 2, shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 6, shadowOffset: { width: 0, height: 2 }, marginBottom: 28 },
  infoRow:        { flexDirection: 'row', alignItems: 'center', paddingVertical: 14, borderBottomWidth: 1, borderColor: C.border },
  ...
  logoutBtn:      { width: '100%', backgroundColor: C.red, borderRadius: 14, paddingVertical: 15, alignItems: 'center' },
